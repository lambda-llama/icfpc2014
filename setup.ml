...
(* OASIS_START *)
(* DO NOT EDIT (digest: 88df73a63c5fd77d49dcba16813d3838) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          oasis_version = "0.4";
          ocaml_version = Some (OASISVersion.VGreaterEqual "4.0.1");
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Aleksey Kladov"; "Sergei Lebedev"; "Pavel Yakovlev"];
          homepage = Some "https://github.com/lambda-llama/icfpc2014";
          synopsis = "ICFPC";
          description = None;
          categories = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "bin_src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "lm"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.2";
     oasis_digest = Some "\190v\220yh\255\175\250\244i\141\0031\243\2148";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
